...
import com.spring.recopay.domain.AjaxWriteList;
import com.spring.recopay.domain.AjaxWriteResult;
import com.spring.recopay.domain.WriteDTO;
import com.spring.recopay.service.AjaxService;
...
public class AjaxController {
	...
	public AjaxWriteList prfnames(@PathVariable String prfname) {
		...
		try {
			list = ajaxService.getPrfnames(prfname);  // 조회수 증가 + 읽기
